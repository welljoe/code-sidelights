/* ********************************************************************/
/* *   File               :    PARMENTER_DAT.h
                             
/* *   Short Description  :    Database Class ,PARMENTERS CONFIG DATA
...
/* ********************************************************************/
#ifndef         PARMENTER_DAT_H             
#define      PARMENTER_DAT_H             
...
//=======================
//                       
virtual ~PARMENTER_DAT();
//					
//C O P Y  -  C O N S T R U C T O R 
//==================================
PARMENTER_DAT(const PARMENTER_DAT &inst);
//					
...
//short	parmGrade= Unit[-]:paramenter grade (by steel grade ,width,thinckness etc.).Limit:[-,-]
PARMENTER_DAT( short arg1,char* arg2,short arg3);
...
void fillStructure()
{
	structPARMENTER_DAT.parmNo = parmNo();
	strncpy (structPARMENTER_DAT.parmName, parmName(), sizeof( structPARMENTER_DAT.parmName));
	structPARMENTER_DAT.parmGrade = parmGrade();
	structPARMENTER_DAT.pSetVal = pSetVal();
	structPARMENTER_DAT.pSetValZi = pSetValZi();
	structPARMENTER_DAT.pMaxVal = pMaxVal();
	structPARMENTER_DAT.pMaxValZi = pMaxValZi();
	structPARMENTER_DAT.pMinVal = pMinVal();
	structPARMENTER_DAT.pMinValZi = pMinValZi();
	structPARMENTER_DAT.pAvgVal = pAvgVal();
	structPARMENTER_DAT.pAvgValZi = pAvgValZi();
	structPARMENTER_DAT.pClMaxVal = pClMaxVal();
	structPARMENTER_DAT.pClMaxValZi = pClMaxValZi();
	structPARMENTER_DAT.pClMinVal = pClMinVal();
	structPARMENTER_DAT.pClMinValZi = pClMinValZi();
	structPARMENTER_DAT.bShow = bShow();
	structPARMENTER_DAT.bShowZi = bShowZi();
	structPARMENTER_DAT.bSave = bSave();
	structPARMENTER_DAT.bSaveZi = bSaveZi();
	strncpy (structPARMENTER_DAT.sp2, sp2(), sizeof( structPARMENTER_DAT.sp2));
	structPARMENTER_DAT.sp2Zi = sp2Zi();
	strncpy (structPARMENTER_DAT.toc, toc(), sizeof( structPARMENTER_DAT.toc));
	structPARMENTER_DAT.tocZi = tocZi();
	strncpy (structPARMENTER_DAT.tom, tom(), sizeof( structPARMENTER_DAT.tom));
	structPARMENTER_DAT.tomZi = tomZi();
	strncpy (structPARMENTER_DAT.mop, mop(), sizeof( structPARMENTER_DAT.mop));
	structPARMENTER_DAT.mopZi = mopZi();
	return; 
}
...
public:
//
PARMENTER_DAT operator+(const PARMENTER_DAT &inst) const;
...
public:
//
const PARMENTER_DAT& operator=(const PARMENTER_DAT &inst);
